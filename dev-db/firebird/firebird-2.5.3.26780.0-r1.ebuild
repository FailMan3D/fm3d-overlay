...
# Modified by FailMan3D on 2015-01-26, summary of modifications:
#	* Fixed building with USE="-superserver xinetd"; change starts at line 78
#		Official ebuild erroneously applies the SuperClassic patch in this case.
#	* Added link to GPLv2 on line 3
...
src_prepare() {
	...
	if use superserver ; then
		einfo "SuperServer, not applying SuperClassic patch"
	elif use xinetd ; then
		einfo "Classic server, not applying SuperClassic patch"
	else # SuperClassic
		einfo "USE='-superserver -xinetd', applying SuperClassic patch"
